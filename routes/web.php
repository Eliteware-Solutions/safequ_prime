...
Route::get('/community_user/login/{id}', 'HomeController@community_user_login')->name('community_user.login');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/pending-order-export', 'OrderController@pending_order_export')->name('pending_order_export.excel');
...
Route::get('razorpay/payment/user-bill-payment-link-success', 'RazorpayController@user_bill_payment_link_success')->name('payment.user_bill_payment_link_success');

Route::post('razorpay/payment/payment-link-webhook', 'RazorpayController@payment_link_webhook')->name('payment.payment_link_webhook');

Route::post('razorpay/payment/web-payment-webhook', 'RazorpayController@web_payment_webhook')->name('payment.payment_link_webhook');
