                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @if (Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.past_orders') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.past_orders']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Past Orders') }}</span>
                                </a>
                            </li>
                            {{-- <li class="aiz-side-nav-item">
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('lost-users.report') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Lost Customers') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
