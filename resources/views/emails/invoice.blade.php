        ...
        <div style="background: #eceff4;padding: 1.5rem;">
            <table>
                <tr>
                    <td>
                        @if ($logo != null)
                            <img loading="lazy" src="{{ uploaded_asset($logo) }}" height="65"
                                style="display:inline-block;">
                        @else
                            <img loading="lazy" src="{{ static_asset('assets/img/new-design/safequ-logo.png') }}"
                                height="65" style="display:inline-block;">
                        @endif
                    </td>
                </tr>
            </table>
