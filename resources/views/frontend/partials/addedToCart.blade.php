<div class="modal-body p-4 added-to-cart">
    ...
    <div class="media mb-4">
        <img src="{{ static_asset('assets/img/no-image-found.jpg') }}" data-src="{{ uploaded_asset($product->thumbnail_img) }}" class="mr-3 lazyload size-100px img-fit rounded" alt="Product Image">
