                            ...
                            <div class="col-md-7 px-0">
                                <div class="slider-content animate__animated animate__fadeInLeft 100vh pr-lg-5 py-4">
                                    ...
                                    <p class="mb-2 pr-md-4 fw500 sub-txt">Farm fresh produce like strawberries &
                                        avocados delivered to your doorstep, <span class="fw700 fsize17 primary-color">DIRECTLY</span> from your choice
                                        of
                                        local farms serving your community. ~30% cheaper than those expensive <u class="fw500 text-underline">halls of food</u> or <u class="fw500 text-underline">baskets of nature</u> <i class="fas fa-smile-wink smiley primary-color-dark align-middle"></i>
                                    </p>
                ...
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs tabslider" role="tablist">
                            <li role="presentation"><a id="eventBtn" class="active" href="#home" aria-controls="home" role="tab" data-toggle="tab">all</a></li>
                            <li role="presentation"><a href="#profile" class="sec" aria-controls="profile" role="tab" data-toggle="tab">Fruit</a></li>
                            <li role="presentation"><a href="#profile2" class="sec" aria-controls="profile2" role="tab" data-toggle="tab">Vegetables</a></li>
                            <li role="presentation"><a href="#profile3" class="sec" aria-controls="profile3" role="tab" data-toggle="tab">Flowers</a></li>
                        ...
                        <div class="tab-content py-0">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <div id="owl-example" class="owl-carousel alltabs ">
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-2.png" class="img-rounded" alt="">
                                            </div>
                                            <div class="tabcard-detail">
                                                <span>Afghanistan</span>
                                                <p class="titlecard">Afghanistan Apricot</p>
...
">
                                    ...
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-1.svg" class="img-rounded" alt="">
                                            </div>
                                            <div class="tabcard-detail">
                                                <span>Kodaikanal</span>
                                                <p class="titlecard">Mangosteen</p>
                                                <p class="price">₹ 349.00 / 500 Gms</p>
                                                <div class="cartbtn
">
                                                    <img src="public/assets/img/carts.svg" class=" cart" alt="cart">
                                    ...
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-3.svg" class="img-rounded" alt="">
                                            </div>
                                            <div class="tabcard-detail">
...
">
                                    ...
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-4.svg" class="img-rounded" alt="">
                                            </div>
                                            <div class="tabcard-detail">
                                                <span>New Zealand</span>
                                                <p class="titlecard">Green Kiwi
                                                </p>
                                                <p class="price">₹ 149.00 / Piece</p>
                                                <div class="cartbtn
">
                                                    <img src="public/assets/img/carts.svg" class=" cart" alt="cart">
                                                    <a href="#" class="cartbtn">
                                    ...
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-1.svg" class="img-rounded">
                                            </div>
                                            <div class="tabcard-detail">
                                                <span>Afghanistan2</span>
                                                <p class="titlecard">Afghanistan Apricot</p>
...
">
                                    ...
                                    <div class="tab_slider_card">
                                        <div>
                                            <div class="card-img mb-1">
                                                <img src="public/assets/img/simg-2.png" class="img-rounded">
                                            </div>
                                            <div class="tabcard-detail">
                                                <span>Afghanistan2</span>
                                                <p class="titlecard">Afghanistan Apricot</p>
...
">
                            ...
                            <div class="item py-3 px-2">
                                <div class="community-card mx-auto p-3 pt-4">
                                    <div class="card-img mb-1">
                                        ...
                                        <img src="{{ uploaded_asset($community->user->avatar_original) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" class="img-rounded" alt="{{ $community->name }}">
                                        @else
                                        <img src="" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" class="img-rounded" alt="{{ $community->name }}">
                                        @endif
                                    </div>
                                    ...
                                    <a href="javascript:void(0);" class="btn primary-btn btn-block fw600 text-white" onclick="confrimCommunityChange('{{ route('shop.visit', $community->slug) }}');">JOIN</a>
                                    @else
                                    <a href="{{ route('shop.visit', $community->slug) }}" class="btn primary-btn btn-block fw600 text-white">JOIN</a>
                                    @endif
    ...
    <div class="py-5">
        <div class="container mb-3">
            <h4 class="fw700 text-center">Why communities love <i class="fa fa-heart animated faa-pulse primary-color"></i> SafeQU?</h4>
    ...
    <div class="modal fade changeCommunityModal" id="changeCommunityModal" tabindex="-1" aria-labelledby="changeCommunityModalLabel" aria-hidden="true">
