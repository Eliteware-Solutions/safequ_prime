                    ...
                    <div class="container">
                        ...
                        <div class="hedtab">
                            ...
                            <ul class="nav nav-tabs" id="tabs">
                                <li><a href="#" data-toggle="tab" data-filter="all" class="active filter-button">All</a></li>
                                @foreach ($categories as $key => $cat)
                                    <li>
                                        <a href="#" data-toggle="tab" data-filter="{{ $cat['filter'] }}" class="filter-button">
                                            {{ $cat['name'] }}
                                        </a>
                                    </li>
                                @endforeach
                                            ...
                                            <div class="viewbtns">
                                                ...
                                                <div>
                                                    <ul class="nav nav-tabs" id="repoTabs2">
                                                        <li class="pl-2"><a href="#repoInfo2" data-toggle="tab"><img
                                                                    src="../public/assets/img/inrtab1dot.svg" alt="dot1"
                                                                    class="tabdots1"></a></li>
                                                        <li class="pl-2"><a href="#repoStats2" data-toggle="tab"><img
                                                                    src="../public/assets/img/inrtab2dot.svg" alt="dot2"
                                                                    class="tabdots2"></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane active" id="repoInfo2">
                                        <div class="row ">
                                            @foreach ($products_purchase_started as $product)
                                                ...
                                                @endphp
                                                <div class="col-lg-3 col-md-6 alltabs filter {{ $product->product->category->slug }} ">
                                                    <div class="tab_slider_card">
                                                        <div>
                                                            <div class="card-img mb-1">
                                                                <img src="{{ uploaded_asset($product->product->photos) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" class="img-rounded top_img" alt="{{ $product->product->name }}">
                                                            </div>
                                                            <div class="tabcard-detail">
                                                                <span> {{ ($product->product->manufacturer_location ? $product->product->manufacturer_location : '--') }} </span>
                                        ...
                                        <div class="row ">
                                                ...
                                                <div class="col-lg-6 filter {{ $product->product->category->slug }} ">
                                                    <div class=" tab_horizontal_card">
                                                        <div class="tab_hori_inr">
                                                            <div>
                                                                <img src="{{ uploaded_asset($product->product->photos) }}"  onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" class="img-rounded top_img" alt="{{ $product->product->name }}"></div>
                                                            <div class="  tab_horizontal_card_detail  ">
                                                                ...
                                                                <div class="dleverdt">
                                                                <span class="d-inline-block pr-2">
                                                                    <img src="../public/assets/img/truck-blk.svg" class=" truck-blk "
                                                                         alt="truck-blk">
                                                                </span>
                                                                    {{ date('dS F', strtotime($product->purchase_end_date. '+' . intval($product->est_shipping_days) . ' days')) }}
                                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <a href="#" class="loadbtn">
                                                    <img src="../public/assets/img/Vector.png" class="proces mr-2" alt="proces">
                                                    Load More
                                                </a>
                                            </div>
                                        </div>
