                            ...
                            <div class="container">
                                ...
                                <div class="hedtab">
                                    ...
                                    <ul class="nav nav-tabs" id="tabs" role="tablist">
                                        <li>
                                            <a class="active" href="#all_prd" aria-controls="all_prd" role="tab"
                                                data-toggle="tab">all</a>
                                        </li>

                                        @foreach ($categories as $p_cat)
                                            <li>
                                                <a href="{{ route('shop.filter', $shop->slug, $p_cat['id']) }}" class="active sec">{{ $p_cat['name'] }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                    <!-- Tabs -->
                                ...
                                <div class="tab-content tab-content middlesec">
                                    ...
                                    <!-- Repo -->
                                    <div class="tab-pane active" id="all_prd">
                                            ...
                                            <div class="viewbtns">
                                                ...
                                                <div>
                                                    <ul class="nav nav-tabs" id="repoTabs">
                                                        <li class="pl-2">
                                                            <a href="#repoInfo" data-toggle="tab">
                                                                <img src="../public/assets/img/inrtab1dot.svg"
                                                                    alt="dot1" class="tabdots1">
                                                            </a>
                                                        </li>
                                                        <li class="pl-2">
                                                            <a href="#repoStats" data-toggle="tab">
                                                            ...
                                                            <div class="tab_slider_card">
                                                                <div>
                                                                    ...
                                                                    <div class="tabcard-detail">
                                                                        ...
                                                                        <p id="unit_display_{{ $prd_val->id }}" class="price">
                                                                            {!! single_price_web($prd_val->product_price) !!} /
                                                                            {{ $prd_val->qty_unit_main }}
                                                                        </p>
                                                                        <div class="cartbtn">
                                                                        ...
                                                                        <div class="dlever">
                                                                            ...
                                                                            {{ date('dS F', strtotime($prd_val->purchase_end_date . '+' . intval($prd_val->est_shipping_days) . ' days')) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                                ...
                                                                <div class="countitem">
                                                                    <div class="input-group w-auto counterinput">
                                                                        <input type="button" value="-"
                                                                            ...
                                                                            data-field="quantity"
                                                                            data-product_id="{{ $prd_val->product->id }}"
                                                                            data-product_stock_id="{{ $prd_val->id }}">
                                                                        <input type="number" step="1"
                                                                            max="10"
                                                                            value="{{ $prd_val->cart_qty }}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <a href="#" class="loadbtn">
                                                            <img src="../public/assets/img/Vector.png" class="proces mr-2"
                                                                alt="proces">
                                                            Load More
                                                        </a>
                                                    </div>
