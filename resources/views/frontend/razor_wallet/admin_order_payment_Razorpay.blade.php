    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            let options = {
                ...
                "amount": "{{round(($order_data->grand_total - $wallet_amount) * 100)}}", //amount need to be in multiple of 100
                ...
                "modal": {
                    "ondismiss": function () {
                        window.location.href = '{{ route('cart.adminOrderCheckout', [ 'id' => $order_data->user_id, 'order_id' => $order_data->id ]) }}';
                    }
                }
            };
